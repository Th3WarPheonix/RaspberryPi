...
//------------------------------------------------------------------------------
// Returns the binary number equivalent to the refresh rate
// Value Returned | Refresh Rate
// 0 | 0.5 HZ 
// 1 | 1 HZ 
// 2 | 2 HZ 
// 3 | 4 HZ 
...
//------------------------------------------------------------------------------
// mode = 0 if interleaved mode is set
// mode = 1 if chess pattern mode is set
