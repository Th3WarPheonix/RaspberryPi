...
typedef ssize_t (*I2C_READ_HANDLE)(const struct i2c_device *dev, unsigned int iaddr, void *buf, size_t len);
typedef ssize_t (*I2C_WRITE_HANDLE)(const struct i2c_device *dev, unsigned int iaddr, const void *buf, size_t len);
